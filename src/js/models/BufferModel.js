...
export default class BufferModel {
  ...
  init() {
    this.loader = new THREE.BufferGeometryLoader(this.loadingManager);
    this.loader.load(this.src, geometry => {
      //console.log(materials);
      const texture = new THREE.MeshPhongMaterial({color: 0x808080, shininess: 8, specular: 0xaaaaaa, reflectivity: .6});
